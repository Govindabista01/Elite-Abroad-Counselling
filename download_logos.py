...
logos = {
    ...
    "university-college-london-ucl": "https://upload.wikimedia.org/wikipedia/en/a/a4/University_College_London_logo.svg",
    "london-school-of-economics": "https://upload.wikimedia.org/wikipedia/commons/1/1b/LSE_Logo.svg",
    "london-school-of-economics-lse": "https://upload.wikimedia.org/wikipedia/commons/1/1b/LSE_Logo.svg",
...
def download(slug, url):
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=15) as resp:
            data = resp.read()
        # Skip tiny files (likely 404 pages)
        if len(data) < 500:
            print(f"  TINY  {filename} ({len(data)} bytes) - skipping")
            return None
